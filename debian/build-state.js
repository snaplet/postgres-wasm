...
var OUTPUT_FILE = path.join(__dirname, "/../images/debian-state-base.bin");
...
var emulator = new V86({
    ...
    filesystem: {
        basefs: {
            url: path.join(__dirname, "/../images/debian-base-fs.json"),
        },
        baseurl: path.join(__dirname, "/../images/debian-9p-rootfs-flat/"),
    },
    screen_dummy: true,
});
